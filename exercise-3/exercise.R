...
# Answer: State names are within state_abbr
#         It is in the form of abbreviations
...
# Answer: state names are in "region" (and they are in abbreviations)
# the column with county names is "subregion"
